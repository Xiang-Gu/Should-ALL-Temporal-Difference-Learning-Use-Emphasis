...
INF = 1000. # When performance measure is np.float('inf'), we replace it with this number so we can plot it to a graph
NUM_TRAINING_EPISODES = 3000 # Number of training episodes
COMMON_PATH = '/Users/rlai/Desktop/Research_UofA/MountainCar_Control/'
