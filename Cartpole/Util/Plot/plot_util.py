...
# This constant is useless in Cartpole because a bad action will lead to small performance measure (# of steps before falling off)
...
COMMON_PATH = '/Users/rlai/Desktop/Research_UofA/Cartpole/'
...
def get_each_line(eachline):
    ...
    if result == float('inf'): # If one file goes to infinity, just assume this parameter setting will make the algorithm diverge
        result = INF
    return result
